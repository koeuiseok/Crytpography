...
static unsigned char HIGHT_F0_F1[512] = {
...
void asm_hight_enc(unsigned char* text, unsigned char* use_key, unsigned char* HIGHT_F0)
{
...
int main(void)
{
    ...
    asm_hight_enc(plaintext, use_key,HIGHT_F0_F1);
