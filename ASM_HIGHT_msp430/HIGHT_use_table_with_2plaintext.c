...
void asm_hight_enc(unsigned short* text, unsigned char* use_key, unsigned char* HIGHT_F0)
{
 ...
 //================8 ROUND OVER==============================
  ...
  asm("swpb r5\n\t");  
    ...
    asm("mov.b 0x5(r13), r12\n\t");
      asm("xor.w r12, r7\n\t");
  asm("swpb r12\n\t");
  asm("xor.w r12, r7\n\t");

  
    asm("mov.b 0x6(r13), r12\n\t");
  asm("swpb r12\n\t");
  asm("add.w r12, r9\n\t");
  asm("swpb r9\n\t");    
  asm("add.w r12, r9\n\t"); 
...
//  asm(" xor.b 0x7(r13), r11\n\t");   
  ...
  asm("pop.w r12\n\t");
  asm("mov.w r5, 0x0(r12)\n\t");
  asm("mov.w r6, 0x1(r12)\n\t");
  asm("mov.w r7, 0x2(r12)\n\t");
  asm("mov.w r8, 0x3(r12)\n\t");
  asm("mov.w r9, 0x4(r12)\n\t");
  asm("mov.w r10, 0x5(r12)\n\t");
  asm("mov.w r11, 0x6(r12)\n\t");
  asm("mov.w r4, 0x7(r12)\n\t");
