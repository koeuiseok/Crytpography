...
#if double_pt
void two_asm_enc(u16* PLAIN_TEXT1, u16* ROUND_KEY)
{

    asm(" mov.w 0x0(r12), r4\r\n");
    asm(" mov.w 0x1(r12), r5\r\n");
    asm(" mov.w 0x2(r12), r6\r\n");
    asm(" mov.w 0x3(r12), r7\r\n");
    asm(" mov.w 0x4(r12), r8\r\n");
    asm(" mov.w 0x5(r12), r9\r\n");
    asm(" mov.w 0x6(r12), r10\r\n"); //평문을 general register에 저장
    asm(" mov.w 0x7(r12), r11\r\n");  //평문 주솟값 : r12
    asm(" push r12\r\n");
    ...
    //key add
        ...
        asm(" xor.w 0x0(r13), r4\r\n");
        asm(" xor.w 0x1(r13), r5\r\n");
        asm(" xor.w 0x2(r13), r6\r\n");
        asm(" xor.w 0x3(r13), r7\r\n");
        asm(" xor.w 0x4(r13), r8\r\n");
        asm(" xor.w 0x5(r13), r9\r\n");
        asm(" xor.w 0x6(r13), r10\r\n");
        asm(" xor.w 0x7(r13), r11\r\n");
